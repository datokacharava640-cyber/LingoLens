...
class MainScreen(Screen):
    ...
    def trigger_translation(self, text):
        ...
        def handle_response(success, data):
            if success and isinstance(data, dict) and "translated" in data:
                ...
                self.ids.output_text.text = f"[ოფლაინ თარგმანი / შეცდომა]\n{text}"
    ...
    def open_interpreter_mode(self):
        ...
        box.add_widget(lbl)
        popup = Popup(title="ინტერპრეტატორი", content=box, size_hint=(0.85, 0.6))
        popup.open()
    ...
    def open_dictionary_hub(self):
        ...
        box.add_widget(lbl)
        popup = Popup(title="ლექსიკონი", content=box, size_hint=(0.85, 0.6))
        popup.open()
    ...
    def open_quiz_mode(self):
        ...
        box.add_widget(lbl)
        popup = Popup(title="ქვიზი", content=box, size_hint=(0.85, 0.6))
        popup.open()
