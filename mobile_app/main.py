...
# 1. გადასვლა სამუშაო დირექტორიაში
os.makedirs('/content/mobile_app', exist_ok=True)
%cd /content/mobile_app

# 2. AndroidManifest.tmpl.xml ფაილის შექმნა
...
# 3. main.py-ს ჩაწერა ავტორის, თარიღის და ლიცენზიების ინფორმაციით
main_code = '''"""
