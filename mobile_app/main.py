# LingoLens Ultra Pro v9.5.0 (Global Master Edition with Georgian & World Grammar, Reasoning, Native Speech Engine & Permissions)
# ========================================================================
...
# ----------------------------------------------------
# 0. Android Dynamic Permissions Manager
# ----------------------------------------------------
...
class LingoLensApp(App):
    ...
    def on_start(self):
        # აპლიკაციის ჩართვისთანავე ითხოვს Android-ის ნებართვებს (კამერა, მიკროფონი, SMS)
