...
def request_android_permissions():
    """Android-ის ნებართვების უსაფრთხო მოთხოვნა API Level-ის მიხედვით"""
    if platform == 'android':
        try:
...
# ----------------------------------------------------
# 2. Languages & Data (მსოფლიოს ენების სრული სია)
# ----------------------------------------------------
LANGUAGES = {
    ...
    "Greek (ბერძნული)": "el",
    "Czech (ჩეხური)": "cs",
    "Romanian (რუმინული)": "ro",
    "Hungarian (უნგრული)": "hu",
    "Swedish (შვედური)": "sv",
    "Danish (დანიური)": "da",
    "Finnish (ფინური)": "fi",
    "Norwegian (ნორვეგიული)": "no",
    "Bulgarian (ბულგარული)": "bg",
    "Croatian (ხორვატიული)": "hr",
    "Serbian (სერბული)": "sr",
    "Slovak (სლოვაკური)": "sk",
    "Slovenian (სლოვენური)": "sl",
    "Lithuanian (ლიეტუვური)": "lt",
    "Latvian (ლატვიური)": "lv",
    "Estonian (ესტონური)": "et",
    "Irish (ირლანდიური)": "ga",
    "Albanian (ალბანური)": "sq",
    "Macedonian (მაკედონური)": "mk",
    "Maltese (მალტური)": "mt",
    "Icelandic (ისლანდიური)": "is",
    "Belarusian (ბელარუსული)": "be",
    "Catalan (კატალანური)": "ca",
    "Galician (გალისიური)": "gl",
    "Basque (ბასკური)": "eu",
    "Welsh (უელსური)": "cy",
    "Esperanto (ესპერანტო)": "eo",
    "Chinese Simplified (ჩინური გამარტივებული)": "zh-CN",
    "Chinese Traditional (ჩინური ტრადიციული)": "zh-TW",
    "Japanese (იაპონური)": "ja",
    "Korean (კორეული)": "ko",
    "Hindi (ჰინდი)": "hi",
    "Bengali (ბენგალური)": "bn",
    "Urdu (ურდუ)": "ur",
    "Indonesian (ინდონეზიური)": "id",
    "Vietnamese (ვიეტნამური)": "vi",
    "Thai (ტაილანდური)": "th",
    "Malay (მალაიური)": "ms",
    "Filipino (ფილიპინური)": "tl",
    "Tamil (ტამილური)": "ta",
    "Telugu (ტელუგუ)": "te",
    "Marathi (მარათჰი)": "mr",
    "Gujarati (გუჯარათი)": "gu",
    "Kannada (კანადა)": "kn",
    "Malayalam (მალაიალამი)": "ml",
    "Punjabi (პენჯაბური)": "pa",
    "Nepali (ნეპალური)": "ne",
    "Sinhala (სინჰალური)": "si",
    "Myanmar / Burmese (ბირმული)": "my",
    "Khmer (ქმერული)": "km",
    "Lao (ლაოსური)": "lo",
    "Mongolian (მონღოლური)": "mn",
    "Arabic (არაბული)": "ar",
    "Turkish (თურქული)": "tr",
    "Persian / Farsi (პარსული)": "fa",
    "Hebrew (ებრაული)": "he",
    "Armenian (სომხური)": "hy",
    "Azerbaijani (აზერბაიჯანული)": "az",
    "Kurdish (ქურთული)": "ku",
    "Pashto (პუშტუ)": "ps",
    "Kazakh (ყაზახური)": "kk",
    "Uzbek (უზბეკური)": "uz",
    "Turkmen (თურქმენული)": "tk",
    "Tajik (ტაჯიკური)": "tg",
    "Kyrgyz (ყირგიზული)": "ky",
    "Swahili (სუაჰილი)": "sw",
    "Afrikaans (აფრიკაანსი)": "af",
    "Amharic (ამჰარული)": "am",
    "Hausa (ჰაუსა)": "ha",
    "Yoruba (იორუბა)": "yo",
    "Zulu (ზულუ)": "zu",
    "Xhosa (ქოსა)": "xh",
    "Somali (სომალური)": "so",
    "Malagasy (მალაგასიური)": "mg",
    "Maori (მაორი)": "mi",
    "Samoan (სამოური)": "sm",
    "Haitian Creole (ჰაიტიური კრეოლი)": "ht",
    "Latin (ლათინური)": "la"
}
...
# ----------------------------------------------------
# 3. Native Speech Manager (TTS & STT)
# ----------------------------------------------------
class NativeSpeechManager:
    ...
    def start_listening(lang_code, callback_text):
        ...
        if platform == 'android':
            ...
            if callback_text:
                Clock.schedule_once(lambda dt: callback_text("ხმის ამოცნობა სიმულირებულია (Desktop)..."), 0)
...
class MainScreen(Screen):
    ...
    def open_quiz_mode(self):
        ...
        layout = BoxLayout(orientation='vertical', padding=10, spacing=10)
        lbl = Label(text=item['q'], font_name=FONT_PATH, font_size='16sp', size_hint_y=0.4)
        layout.add_widget(lbl)
        popup = Popup(title='📝 ქვიზი', font_name=FONT_PATH, content=layout, size_hint=(0.85, 0.6))
        ...
        for opt in item['options']:
            btn = Button(text=opt, font_name=FONT_PATH, size_hint_y=0.2)
            btn.bind(on_release=lambda x, o=opt: check_ans(o))
...
class LingoLensApp(App):
    ...
    def on_start(self):
        # ეკრანის ჩატვირთვიდან 1.2 წამის დაყოვნებით მოვითხოვთ ნებართვებს
        Clock.schedule_once(lambda dt: request_android_permissions(), 1.2)
