...
# 2. თქვენი სრული main.py კოდის ჩაწერა
main_code = '''import os
import json
import sqlite3
import threading
...
# Picovoice Porcupine-ის ბიბლიოთეკების იმპორტი
try:
    import pvporcupine
...
# ჩასვით თქვენი უფასო AccessKey Picovoice Console-დან
...
# 3. buildozer.spec-ის შექმნა ყველა აუცილებელი ბიბლიოთეკითა და უფლებით
spec_code = '''[app]
...
version = 3.6.0
requirements = python3,kivy,requests,urllib3,chardet,certifi,idna,openssl,pvporcupine,pvrecorder,pyjnius
orientation = portrait
fullscreen = 0
android.permissions = INTERNET,CAMERA,RECORD_AUDIO,WRITE_EXTERNAL_STORAGE,READ_EXTERNAL_STORAGE,FOREGROUND_SERVICE,ACCESS_NETWORK_STATE
android.api = 33
android.minapi = 24
android.ndk = 25b
...
# 4. APK-ს აწყობის პროცესის გაშვება
