...
class NativeSpeechManager:
    ...
    def start_listening(lang_code, callback_text):
        if platform == 'android':
            ...
            callback_text("[Desktop Simulation]: ხმოვანი შეყვანა აქტიურია...")
...
class MainScreen(Screen):
    ...
    def swap_languages(self):
        ...
        in_txt = self.ids.input_text.text
    ...
    def start_speech_to_text(self, lang):
        trigger_vibration()
        NativeSpeechManager.start_listening(lang, lambda t: setattr(self.ids.input_text, 'text', t))
    ...
    def open_interpreter_mode(self):
        ...
        def _listen_a(instance):
            NativeSpeechManager.start_listening('ka', lambda t: log_input.insert_text(f"\n[KA]: {t}"))
        def _listen_b(instance):
            NativeSpeechManager.start_listening('en', lambda t: log_input.insert_text(f"\n[EN]: {t}"))
