...
# requirements - დამატებულია hostpython3 და kivy-ს სტაბილური ვერსია
requirements = python3,hostpython3,kivy==2.3.0,certifi,urllib3,requests,idna,chardet,plyer,pyjnius

# ეკრანის ორიენტაცია
orientation = portrait
fullscreen = 0

# Android უფლებები (Permissions) - გასუფთავებულია ზედმეტი ნებართვებისგან
