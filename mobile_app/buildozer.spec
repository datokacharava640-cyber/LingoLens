...
# აუცილებელი Python ბიბლიოთეკები Android-ისთვის (android პაკეტი ამოღებულია Cython 3 კონფლიქტის გამო)
requirements = python3,kivy,certifi,urllib3,requests,idna,chardet,plyer,pyjnius,sqlite3,openssl

# ეკრანის ორიენტაცია
orientation = portrait
fullscreen = 0

# Android უფლებები (Permissions) - მათ შორის Bluetooth & Hardware Mic
