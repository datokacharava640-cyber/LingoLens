...
# 1. სამუშაო დირექტორიაში გადასვლა/შექმნა
os.makedirs('/content/mobile_app', exist_ok=True)
%cd /content/mobile_app

# 2. AndroidManifest.tmpl.xml ფაილის შექმნა (Custom Template)
...
# 3. buildozer.spec ფაილის ჩაწერა თქვენი პარამეტრებით
spec_content = '''[app]
...
# 4. buildozer-ის გაშვება APK-ს დასაგენერირებლად
