...
# გასწორებული requirements: Python 3.11-ის ფიქსირებული ვერსიით (3.14 შეცდომის ასარიდებლად)
# ამოღებულია sqlite3 და openssl (რომლებიც ავტომატურად შედის Python-ში)
requirements = python3==3.11.0,kivy,certifi,urllib3,requests,idna,chardet,plyer,pyjnius
