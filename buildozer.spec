...
# (list) Source files to include (include all required extension types)
...
# შენიშვნა: ვერსიის ნომრების გარეშე დატოვეთ python3, pyjnius, kivy და პაკეტები
requirements = python3,kivy,pyjnius,plyer,chardet,idna,certifi,pillow,requests
