...
# დაფიქსირებული თავსებადი ვერსიები
requirements = python3==3.11.0,kivy==2.2.1,plyer,chardet,idna,requests,urllib3,certifi,pillow
...
# SDK / NDK პარამეტრები (სტაბილური API 33)
android.api = 33
android.minapi = 24
android.ndk = 25b
...
# რესურსების საქაღალდე და მანიფესტი
