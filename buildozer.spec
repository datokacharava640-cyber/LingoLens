...
# (list) Application requirements (მკაცრად განსაზღვრული Python 3.10 და NumPy 1.26.4)
requirements = python3==3.10.12,kivy==2.3.0,android,pyjnius,numpy==1.26.4,opencv_python,requests,urllib3,certifi,openssl
