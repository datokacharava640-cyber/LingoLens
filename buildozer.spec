...
# ამოღებულია ==3.11.0, რათა hostpython3 და python3 ვერსიები დაემთხვეს
requirements = python3,kivy==2.3.0,pillow,requests,urllib3,certifi,openssl

# გამოიყენეთ p4a-ს სტაბილური ტოტი
p4a.branch = master
