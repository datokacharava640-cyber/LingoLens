...
# -----------------------------------------------------------------------------
# დამოკიდებულებები (Requirements) - ჩასწორებულია python3==3.11.5
# -----------------------------------------------------------------------------
requirements = python3==3.11.5,kivy,android,pyjnius,plyer,requests,certifi,urllib3,idna,chardet,openssl

# -----------------------------------------------------------------------------
# python-for-android ვერსიის დაფიქსირება
# -----------------------------------------------------------------------------
p4a.branch = master
