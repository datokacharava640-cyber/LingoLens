...
# (list) Application requirements (გასწორებულია KivyMD და P4A დამოკიდებულებები)
requirements = python3,kivy==2.3.0,https://github.com/kivymd/KivyMD/archive/master.zip,materialyoucolor,asynckivy,plyer,pyjnius,requests,urllib3,openssl
...
# (str) Architecture to build for (მხოლოდ arm64 სრულიად საკმარისია და აჩქარებს აწყობას)
android.archs = arm64-v8a

# (bool) Storage setting
android.private_storage = True

# (str) python-for-android branch (გასწორებულია master-ზე)
p4a.branch = master
