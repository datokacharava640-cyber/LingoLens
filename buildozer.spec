...
# (list) Application requirements (Python 3.10.12-ზე ჩაკეტვა)
requirements = python3==3.10.12,kivy==2.3.0,pyjnius,websocket-client,requests

# (str) Extra arguments for python-for-android
p4a.extra_args = --extra-global-cflags="-w -Wno-error -Wno-deprecated-declarations -Wno-implicit-function-declaration -Wno-incompatible-pointer-types"
