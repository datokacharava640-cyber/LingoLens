...
# ამოღებულია requests და urllib3 (kivy/plyer/urllib33-ის ნაცვლად p4a-ს შიდა რეცეპტები იზრუნებს)
...
p4a.branch = master
# ეხმარება p4a-ს სწორი არგუმენტების გადაცემაში
p4a.extra_args = --python-version=3.11.0
