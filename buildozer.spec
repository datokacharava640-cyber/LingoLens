...
# numpy და websocket-client-ის კონკრეტული ვერსიები build-ის სტაბილურობისთვის
requirements = python3,kivy==2.2.1,pyjnius,numpy,websocket-client
...
# (int) Target Android API (API 31 ყველაზე სტაბილურია Buildozer-ისთვის)
android.api = 31
