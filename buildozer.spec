...
requirements = python3, kivy, openssl, pillow, requests, certifi, urllib3, chardet, idna, charset-normalizer, plyer, android, pyjnius

# (str) Path to local python-for-android source
