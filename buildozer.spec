...
# Requirements (დაემატა pyjnius ხმოვანი ფუნქციონალისთვის)
requirements = python3,kivy,certifi,urllib3,requests,plyer,pyjnius
...
# p4a-ს სტაბილურ შტოზე გადაყვანა Python 3.14-ის თავიდან ასაცილებლად
p4a.fork = kivy
