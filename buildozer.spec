...
# (list) Application requirements (sqlite3 ამოღებულია, დამატებულია KivyMD-ის დამხმარე ბიბლიოთეკები)
requirements = python3,kivy==2.3.0,kivymd==1.2.0,materialyoucolor,asynckivy,plyer,pyjnius,requests,urllib3,openssl
