...
# დამატებულია openssl და urllib3 API-ს გამართული მუშაობისთვის
requirements = python3,kivy==2.3.0,kivymd==1.2.0,requests,plyer,pyjnius,android,openssl,urllib3
...
# Android Permissions (SMS, Internet, Camera, Audio)
