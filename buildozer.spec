...
# (list) Permissions
android.permissions = CAMERA, RECORD_AUDIO, INTERNET, READ_EXTERNAL_STORAGE, WRITE_EXTERNAL_STORAGE, READ_MEDIA_IMAGES, FLASHLIGHT, POST_NOTIFICATIONS, SYSTEM_ALERT_WINDOW, READ_SMS, RECEIVE_SMS, MODIFY_AUDIO_SETTINGS
