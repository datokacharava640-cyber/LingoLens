...
# python3-ის ნაცვლად მივუთითოთ კონკრეტულად python3==3.11.0
requirements = python3==3.11.0,kivy==2.2.1,requests,urllib3,certifi,charset-normalizer,idna,pillow,plyer
