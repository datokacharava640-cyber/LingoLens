...
# (list) Source files to include (დაემატა db)
...
# (list) Application requirements (დაემატა cython)
requirements = python3,kivy==2.3.0,android,pyjnius,opencv,requests,urllib3,certifi,openssl,hostpython3,cython
