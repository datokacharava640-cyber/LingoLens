...
# ამოღებულია hostpython3 ვერსია, დატოვებულია მხოლოდ python3==3.11.0
requirements = python3==3.11.0,kivy==2.3.0,requests,pillow,plyer,urllib3,certifi,chardet,idna,charset-normalizer
