...
# (str) Python for Android branch (შეცვლილია stable-ზე შეცდომების ასარიდებლად)
p4a.branch = stable

# (list) Application requirements (მხოლოდ უმსუბუქესი, აუცილებელი ბიბლიოთეკები)
requirements = python3,kivy==2.3.0,requests,urllib3,certifi,idna,charset-normalizer,plyer
