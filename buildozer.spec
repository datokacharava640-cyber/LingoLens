...
# (list) Application requirements (მითითებულია დაფიქსირებული python3==3.10.12)
requirements = python3==3.10.12,kivy==2.3.0,https://github.com/kivymd/KivyMD/archive/master.zip,materialyoucolor,asynckivy,plyer,pyjnius,requests,urllib3,openssl
