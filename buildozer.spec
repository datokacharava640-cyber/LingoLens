...
source.exclude_patterns = Dockerfile, vercel.json, setup.py, *.ipynb

# (str) Application versioning
version = 6.0.1

# (list) Application requirements - სტაბილური და დაფიქსირებული ვერსიები
requirements = python3==3.10.12, hostpython3==3.10.12, kivy==2.3.0, pillow, requests, certifi, plyer, pyjnius
...
# (str) Android NDK version (ყველაზე სტაბილური API 33-ისთვის)
android.ndk = 25b
