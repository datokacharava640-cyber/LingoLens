...
# python3cpython უზრუნველყოფს სტანდარტულ CPython-ს და არ გადადის ექსპერიმენტულ ვერსიებზე
requirements = python3cpython==3.10.11,kivy,requests,pillow,plyer,urllib3,certifi
