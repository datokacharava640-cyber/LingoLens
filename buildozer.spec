...
# Pillow==9.5.0 არ ითხოვს C314 заголовок-ებს და სტაბილურად კომპილირდება
requirements = python3,kivy==2.2.1,requests,urllib3,certifi,charset-normalizer,idna,pillow==9.5.0,plyer
