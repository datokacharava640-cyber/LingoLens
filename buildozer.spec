...
# openssl-ის ნაცვლად p4a ავტომატურად ამუშავებს urllib3/requests-ის SSL დამოკიდებულებებს
requirements = python3,kivy==2.3.0,requests,pillow,plyer,android,urllib3,certifi
...
# თუ extra_manifest.xml ფაილი არ გაქვთ პროექტის ძირში, ეს სტრიქონი დააკომენტარეთ (#)
