...
# cython, hostpython3 და pip აუცილებელია numpy-ს უშეცდომოდ ასაწყობად
requirements = python3,hostpython3,kivy==2.3.0,pyjnius,websocket-client,cython,numpy
...
# (int) Minimum API required (numpy-სთვის აუცილებელია 24)
android.minapi = 24
