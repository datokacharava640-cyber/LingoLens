...
# python3-ს მივუთითებთ ვერსიის გარეშე, რომ python-for-android-ის hostpython3-თან კონფლიქტი არ მოვიდეს
requirements = python3,kivy==2.2.1,requests,urllib3,certifi,charset-normalizer,idna,pillow,plyer
