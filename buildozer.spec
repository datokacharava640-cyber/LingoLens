...
# (list) Application requirements - დაფიქსირებულია python3==3.11.0
requirements = python3==3.11.0, kivy, openssl, pillow, requests, certifi, urllib3, chardet, idna, charset-normalizer, plyer, android, pyjnius, python-dateutil

# (str) p4a repository and branch
p4a.fork = kivy
p4a.branch = master
