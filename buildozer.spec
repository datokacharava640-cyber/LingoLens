...
requirements = python3,kivy==2.3.0,pyjnius,android,plyer,requests,urllib3,charset_normalizer,certifi,idna,cython==0.29.33,PyPDF2,python-docx
...
# (list) Permissions
android.permissions = CAMERA, RECORD_AUDIO, INTERNET, READ_EXTERNAL_STORAGE, WRITE_EXTERNAL_STORAGE, FLASHLIGHT, POST_NOTIFICATIONS
