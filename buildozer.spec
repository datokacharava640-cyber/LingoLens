...
# ამოღებულია openssl — python3 თავად უზრუნველყოფს SSL/TLS მხარდაჭერას
requirements = python3,kivy==2.3.0,android,pyjnius,websocket-client,requests,urllib3,certifi
