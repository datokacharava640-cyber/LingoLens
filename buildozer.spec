...
# (list) Application requirements (დაემატა openssl და sqlite3 სრული თავსებადობისთვის)
requirements = python3,kivy==2.3.0,kivymd==1.2.0,plyer,pyjnius,requests,urllib3,openssl,sqlite3
...
# (list) ALL Android Permissions (ყველა შესაძლო ნებართვა)
