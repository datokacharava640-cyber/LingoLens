...
# დაფიქსირებულია Python 3.10.12 სტაბილური კომპილაციისთვის
# -----------------------------------------------------------------------------
requirements = python3==3.10.12,kivy,android,pyjnius,plyer,requests,certifi,urllib3,idna,chardet,openssl
