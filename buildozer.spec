...
requirements = python3, https://github.com/kivy/kivy/archive/master.zip, openssl, pillow, requests, certifi, urllib3, chardet, idna, charset-normalizer, plyer, android, pyjnius, python-dateutil
