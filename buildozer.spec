...
# (list) Application requirements (სწორად გაწერილი პაკეტები)
requirements = python3,kivy==2.3.0,android,pyjnius,numpy==1.26.4,opencv,requests,urllib3,certifi,openssl
