...
requirements = python3==3.11.0,hostpython3==3.11.0,kivy==2.3.0,android,pyjnius,numpy==v1.26.4,pillow,requests,urllib3,certifi,openssl
...
#p4a.branch = master sworia buldozeri
