...
# python-for-android სტაბილური პარამეტრები
p4a.fork = kivy
p4a.branch = master

# 'android' პაკეტი ამოღებულია (p4a მას ავტომატურად ამუშავებს)
...
# დამატებითი XML ფაილების ჩართვა (res/xml/file_paths.xml-ისთვის)
android.add_src = res
