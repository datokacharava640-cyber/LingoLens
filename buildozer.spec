...
# (list) Application requirements (ამოღებულია google-generativeai, გასწორებულია python3)
requirements = python3, kivy, openssl, pillow, requests, certifi, urllib3, chardet, idna, charset-normalizer, plyer, android, python-dateutil
