...
# (list) Application requirements (დაფიქსირებულია Python 3.11.0 და Kivy 2.3.0)
requirements = python3==3.11.0,kivy==2.3.0,requests,urllib3,certifi,idna,charset-normalizer,plyer,pypdf,android
