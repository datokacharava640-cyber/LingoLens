...
# (list) Application requirements - გასწორებული და სტაბილური
requirements = python3,kivy==2.3.0,sqlite3,openssl,plyer

# (str) Python-for-Android version / branch (ამოღებულია კონფლიქტური შტო)
