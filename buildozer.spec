...
requirements = python3,kivy==2.3.0,requests==2.31.0,urllib3==2.2.1,certifi==2024.2.2,idna==3.6,charset-normalizer==3.3.2,plyer==2.1.0

# (str) Python-for-Android version / branch (მკაცრად სტაბილური ტოტი)
