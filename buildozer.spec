...
# requests-ის სტაბილური მუშაობისთვის დამატებულია urllib3, certifi, idna, charset_normalizer
requirements = python3,kivy==2.3.0,pyjnius,android,plyer,requests,urllib3,certifi,idna,charset_normalizer,pypdf,openssl
