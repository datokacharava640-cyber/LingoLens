...
# Cython 0.29.33 ფიქსავს "DEF statement is deprecated" შეცდომას Kivy-ს კომპილაციისას
requirements = python3,kivy==2.3.0,cython==0.29.33,requests,urllib3,certifi,idna,charset_normalizer,pyjnius,android
