...
# python3==3.11.0 აცილებს NDK-ს თავსებადობის შეცდომებს კომპილაციისას
requirements = python3==3.11.0,kivy==2.3.0,pyjnius,android,plyer,requests,urllib3,certifi,idna,charset-normalizer,pypdf,openssl
