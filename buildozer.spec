...
# გასწორებული requirements (ამოღებულია openssl და urllib3)
requirements = hostpython3==3.11.5,python3==3.11.5,kivy==2.3.0,android,pyjnius,plyer,chardet,idna,certifi,requests
...
# დამატებულია რესურსების საქაღალდის მითითება (xml/file_paths.xml-ისთვის)
