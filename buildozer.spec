...
# დაფიქსირებული ვერსიები Python 3.11-ისთვის
requirements = hostpython3==3.11.5,python3==3.11.5,kivy==2.3.0,android,pyjnius,plyer,chardet,idna,certifi,urllib3,requests,openssl
