...
# (list) Source files to include (დამატებულია dir მოდულების საქაღალდის ჩასასმელად)
source.include_exts = py,png,jpg,kv,atlas,db,ttf,dir

# (list) Include patterns (აიძულებს Buildozer-ს ჩასვას modules საქაღალდე APK-ში)
