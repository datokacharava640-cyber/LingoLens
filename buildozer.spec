...
# დამატებულია pyjnius ხმოვანი წაკითხვის (TextToSpeech) ფუნქციონალისთვის
requirements = hostpython3==3.11.0,python3==3.11.0,kivy==2.3.0,pillow,requests,urllib3,certifi,openssl,pyjnius
