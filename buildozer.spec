...
# python3 დაფიქსირებულია 3.10.12 ვერსიაზე C-API კონფლიქტის მოსაშორებლად
requirements = python3==3.10.12,kivy==2.3.0,pyjnius,android,plyer,requests,urllib3,charset_normalizer,certifi,idna,PyPDF2,python-docx
