...
# (list) Application requirements (გასუფთავდა კონფლიქტური პაკეტებისგან)
requirements = python3,kivy,requests,plyer,pyjnius,charset-normalizer
...
# (str) python-for-android branch to use (გარანტირებულად იყენებს სტაბილურ ვერსიას Python 3.11-ისთვის)
