...
requirements = python3,kivy==2.3.0,plyer,chardet,idna,certifi,pillow

p4a.bootstrap = sdl2
orientation = portrait
fullscreen = 0

# p4a.branch გათიშულია 502 Bad Gateway შეცდომის თავიდან ასაცილებლად
# p4a.branch = master
