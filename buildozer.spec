...
# Kivy-ს ვერსიის დაფიქსირება კრიტიკულია
requirements = python3,kivy==2.3.0,requests,pillow,plyer,urllib3,certifi,chardet,idna,charset-normalizer

p4a.bootstrap = sdl2
orientation = portrait
fullscreen = 0

# p4a-ს აიძულებს Kivy წყაროდან (source) დააკომპილიროს და არა pip wheel-ით
p4a.hook = 
