...
# Requirements (დაემატა edge-tts, asyncio, aiohttp და მათი დამოკიდებულებები)
requirements = python3,kivy,certifi,urllib3,requests,idna,chardet,plyer,pyjnius,edge-tts,asyncio,aiohttp,attrs,multidict,yarl,frozenlist,aiosignal
