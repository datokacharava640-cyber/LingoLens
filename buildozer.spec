...
# (list) Permissions (გასწორებულია Buildozer-ის სწორ ფორმატზე)
...
# (str) Android NDK version to use (განახლებულია 25c ვერსიაზე)
android.ndk = 25c
...
# (str) Extra Manifest (დროებით გათიშულია იზოლაციის ტესტისთვის)
