...
# (list) Application requirements (დაფიქსირებულია Python-ის ვერსია)
requirements = python3==3.11.8, hostpython3==3.11.8, kivy, pillow, requests, certifi, plyer, pyjnius

# (str) python-for-android git branch to use (სტაბილური ვერსია)
