...
# hostpython3==3.11.0 აიძულებს Buildozer-ს არ გამოიყენოს Python 3.14
requirements = hostpython3==3.11.0,python3==3.11.0,kivy==2.3.0,requests,pillow,plyer,urllib3,certifi,chardet,idna,charset-normalizer
