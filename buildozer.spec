...
# (list) Application requirements (დაემატა plyer უსაფრთხო ნატიური ფუნქციებისთვის)
requirements = python3,kivy,pyjnius,android,plyer,openssl,requests,urllib3,charset_normalizer
...
# (list) Permissions (ყველა პროექტის მოდულისთვის საჭირო უფლება)
