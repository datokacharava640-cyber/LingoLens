...
# Kivy 2.3.0 უზრუნველყოფს ახალ NDK-ებთან თავსებადობას C-შეცდომების გარეშე
requirements = python3,kivy==2.3.0,android,pyjnius,websocket-client,requests,certifi
