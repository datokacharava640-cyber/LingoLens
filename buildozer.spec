...
# გასწორებული requirements
requirements = hostpython3==3.11.5,python3==3.11.5,kivy==2.3.0,android,pyjnius,plyer,chardet,idna,requests
...
# FileProvider-ის სწორად ჩასმა <application> ტეგის შიგნით
