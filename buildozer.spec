...
# (list) Permissions (სტაბილური და უსაფრთხო ნებართვები Android 13/API 33-ისთვის)
android.permissions = INTERNET, RECORD_AUDIO, CAMERA, WAKE_LOCK, POST_NOTIFICATIONS, FOREGROUND_SERVICE

# (list) Android Hardware Features (უზრუნველყოფს კამერისა და მიკროფონის უსაფრთხო ინიციალიზაციას)
