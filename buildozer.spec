...
# შენიშვნა: python3==3.11.0 აიძულებს p4a-ს გამოიყენოს სტაბილური Python 3.11
requirements = python3==3.11.0,kivy,pyjnius,plyer,chardet,idna,certifi,pillow,requests
