...
# (list) Application requirements (Strictly pinned for stability)
requirements = python3,cython==0.29.33,kivy==2.3.0,kivymd==1.2.0,materialyoucolor,asynckivy,plyer,pyjnius,requests,urllib3,openssl,pillow,android
...
# (list) ALL Android Permissions required for Camera, Audio & Storage
