...
# -----------------------------------------------------------------------------
# charset-normalizer-ის აცდენის თავიდან ასაცილებლად ჩამატებულია urllib3<2.0.0 და chardet
requirements = python3,kivy==2.3.0,android,pyjnius,plyer,chardet,idna,certifi,urllib3<2.0.0,requests,openssl
