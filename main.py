...
class LingoLensApp(App):
    def build(self):
        ...
        # 1. სათაური და მენიუს ღილაკი (Header)
        ...
        # 2. ენის არჩევა და სვაპი (Language Swap Bar)
    ...
    def start_live_dialogue(self, mode):
        ...
        if not text:
            self.status_label.text = "⚠️ ჩაწერთ ტექსტი SMS ველში!"
            return
