# ==============================================================================
# LingoLens AI - მთავარი ფაილი (ენების დინამიური მხარდაჭერით)
# ==============================================================================
...
class LingoLensApp(App):
    ...
    def open_translator(self, instance=None, initial_text="", initial_result="", status_text=""):
        ...
        # როდესაც სპინერიდან იცვლება ენა, აპლიკაცია ავტომატურად ცვლის მთელ ტექსტებს
        def on_lang_change(spinner, text):
            selected_code = lang_names.get(text, "ka")
            self.current_lang = selected_code
            # განახლდეს ღილაკებისა და ჰინთების ტექსტები დინამიურად
