...
ADVANCED_OFFLINE_DB = {
    ("ka", "en"): {
        "გამარჯობა": "Hello", "გამარჯობა როგორ ხარ": "Hello, how are you?", "მადლობა": "Thank you",
        "როგორ ხარ": "How are you", "კარგად": "I am fine", "ნახვამდის": "Goodbye"
    },
    ("ka", "it"): {
        "გამარჯობა": "Ciao", "გამარჯობა როგორ ხარ": "Ciao, come stai?", "მადლობა": "Grazie",
        "როგორ ხარ": "Come stai", "კარგად": "Sto bene", "ნახვამდის": "Arrivederci"
    }
}
...
class MainScreen(Screen):
    ...
    def open_main_menu(self):
        ...
        btn_clear = Button(text="ისტორიის გასუფთავება", font_name=FONT_PATH, size_hint_y=None, height='45dp', background_color=(0.7, 0.2, 0.2, 1))
