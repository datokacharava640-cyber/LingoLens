...
class LingoLensUI(BoxLayout):
    ...
    def on_text_change(self, instance, value):
        # Debounce: 0.3 წამის დაყოვნება აკრეფისას
    ...
    def perform_bidirectional_translation(self, text):
        ...
        # ავტო-ამოცნობის რეჟიმში პირდაპირი მოთხოვნა
        if s_lang == "auto":
        ...
        # ორმხრივი თარგმანი: ჯერ ვამოწმებთ შეყვანილი ტექსტის ენას
        ...
        def on_detect_success(req, result):
            try:
                detected_lang = result[2] # ავტომატურად ამოცნობილი ენა
                
                # თუ შეყვანილი ენა ემთხვევა სამიზნე ენას, ვთარგმნით საწყის ენაზე (ორმხრივი მიმართულება)
                ...
                # შეცდომის შემთხვევაში სტანდარტული მიმართულებით თარგმნა
