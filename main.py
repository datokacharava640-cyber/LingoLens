...
# --- 2. ქართული შრიფტის ჩატვირთვა ([X] სიმბოლოების თავიდან ასაცილებლად) ---
...
class LingoLensApp(App):
    def build(self):
        ...
        # ზონა 1-ის მოქმედებები: მოსმენა და დაკოპირება
        ...
        # ზონა 2-ის მოქმედებები: მოსმენა და დაკოპირება
    ...
    # --- 🔊 გახმოვანება მსოფლიოს ნებისმიერი ენისთვის (TTS) ---
    def speak_text(self, text, lang):
        ...
        def run_tts():
            ...
            # 2. ონლაინ TTS რეზერვი ნებისმიერი ენისთვის (მათ შორის ქართულისთვის)
            try:
    ...
    # --- 🎙️ 1. ხმოვანი ამოცნობა (Speech to Text) ---
    ...
    # --- 🔍 2. Live OCR (კამერიდან ტექსტის ამოცნობა) ---
