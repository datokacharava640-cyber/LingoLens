...
# --- 3. პროექტის დამხმარე ფაილების იმპორტი ---
try:
    import config
except ImportError:
    config = None
...
class LingoLensApp(App):
    def build(self):
        ...
        # ზონა 1-ის მოქმედებები: მოსმენა, დაკოპირება, გაზიარება
        ...
        # ზონა 2-ის მოქმედებები: მოსმენა, დაკოპირება, გაზიარება
    ...
    def share_text(self, text):
        ...
        if platform == 'android':
            ...
            self.status_label.text = "📲 კომპიუტერზე ტექსტი დაკოპირდა გაზიარებისთვის!"

    # --- 🔊 2. გახმოვანების ფუნქცია (TTS) ---
    ...
    # --- 📷 4. კამერის ჩართვა/გასწორება (გვერდულად გადაღების გამოსასწორებლად) ---
    def toggle_camera(self, instance):
        if not self.camera_active:
            try:
                self.camera_box.clear_widgets()
                # Android-ზე კამერა რომ არ დატრიალდეს, ვიყენებთ -90 გრადუსით როტაციას
        ...
        if offline_engine and hasattr(offline_engine, 'translate'):
            try:
                ...
                if res:
                    ...
                    if auto_speak:
                        self.speak_text(res, self.target_lang)
                    return
            except Exception:
                pass
