...
class LingoLensDesktopApp(App):
    def build(self):
        # 1.5 წამის დაყოვნება ნებართვებისთვის, რომ აპლიკაცია სტაბილურად ჩაიტვირთოს
    ...
    def open_translator(self, instance=None, initial_text="", initial_result="", status_text=""):
        ...
        # მსოფლიო ენების სიის ჩატვირთვა config.py-დან
        ...
        def handle_translation(btn_inst):
            ...
            # ოფლაინ რეჟიმი (ინტერნეტის გარეშე)
            else:
