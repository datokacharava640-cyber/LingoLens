...
# ⚠️ ჩასვი შენი ნამდვილი Google Gemini API key აქ
GEMINI_API_KEY = os.environ.get("GEMINI_API_KEY", "შენი_GEMINI_API_KEY_აქ")
...
def call_gemini_api(prompt, image_bytes=None):
    if not GEMINI_API_KEY or GEMINI_API_KEY == "შენი_GEMINI_API_KEY_აქ":
...
class LingoLensApp(App):
    ...
    def build(self):
        ...
        # დიალოგის მოდული (Emoji-ების გარეშე, რომ ოთხკუთხედები არ გამოჩნდეს)
