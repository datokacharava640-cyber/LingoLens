# ==============================================================================
# LingoLens AI - მთავარი ფაილი (სრული და სრულად ინტეგრირებული კოდი)
# ==============================================================================
...
# ავტომატური კრაშ-ლოგერი (შეცდომების ჩასაწერად ტელეფონში)
...
class LingoLensApp(App):
    ...
    def get_safe_font(self):
        font = getattr(config, 'FONT_PATH', 'font.ttf')
