...
# ---------------------------------------------------------
# FONT REGISTRATION (GLOBAL UNICODE SUPPORT)
# ---------------------------------------------------------
from kivy.core.text import LabelBase

FONT_PATH = "font.ttf"

# LabelBase-ის დარეგისტრირება
try:
...
class LingoLensPro(MDApp):
    ...
    def build(self):
        # KivyMD-ის ყველა შრიფტის გადაწერა ჩემი ფონტით (კუბიკების აღმოსაფხვრელად)
        for font_style in list(self.theme_cls.font_styles.keys()):
            self.theme_cls.font_styles[font_style] = ["Roboto", 16, False, 0.15]
    ...
    def open_lang_selector(self, caller, mode):
        # Dropdown მენიუს ელემენტებზე ფონტის მითითება
        menu_items = [
            {
                "text": lang,
                "font_name": "Roboto",
