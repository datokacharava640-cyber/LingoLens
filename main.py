# ==============================================================================
# LingoLens AI - With Crash Logger (Window Manager & Dialogue Disabled for Testing)
...
# დაკომენტარებულია window_manager და dialogue_window, რათა შევამოწმოთ ქრაშის მიზეზი
