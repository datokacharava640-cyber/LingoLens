...
# --- 1. ლოკალური SQLite მონაცემთა ბაზა ---
...
# --- 2. Async Network Engine (Non-Blocking API Calls) ---
...
# --- 3. UI/UX (Kivy Language KV String) ---
KV = f'''
<MainScreen>:
    canvas.before:
        Color:
...
class MainScreen(Screen):
    ...
    def open_history_popup(self):
        ...
        close_btn = Button(text="დახურვა", font_name=FONT_PATH, size_hint_y=None, height='40dp', background_color=(0.8, 0.2, 0.2, 1))
    ...
    def open_dialog_mode(self):
        # დიალოგის რეჟიმის პოპაპი
        popup = Popup(title="Live Dialogue Mode", content=Label(text="ორმხრივი დიალოგის რეჟიმი აქტიურია...", font_name=FONT_PATH), size_hint=(0.8, 0.4))
        popup.open()
