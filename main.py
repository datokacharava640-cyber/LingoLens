...
# ენების სია
try:
    from modules.languages import WORLD_LANGUAGES
except ImportError:
    WORLD_LANGUAGES = {
        "ka": "ქართული", "en": "English", "ru": "Русский",
...
class MainLayout(BoxLayout):
    def __init__(self, **kwargs):
        ...
        self.status_label = Label(
            text="მზადაა | 🌐 მსოფლიო ენები ჩატვირთულია",
        ...
        self.dropdown = DropDown(max_height=260)

        modules_list = [
            ("Next-Gen Features", "next_gen_features"),
        ...
        for title, mod_name in modules_list:
            btn = Button(text=title, size_hint_y=None, height=42, background_normal='', background_color=(0.14, 0.18, 0.26, 1))
        ...
        # API Button
        api_btn = RoundedButton(text="Gemini API Key პარამეტრები", bg_color=(0.22, 0.22, 0.3, 1), size_hint_y=0.07)
