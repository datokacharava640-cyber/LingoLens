...
Version             : 3.5.0 (Fully Working Camera, Dialogue & Voice TTS)
...
class LingoLensApp(App):
    ...
    def on_start(self):
        # Android permissions-ის სრული მოთხოვნა
        try:
            ...
            if platform == 'android':
                ...
                def callback(permissions, results):
                    if all(results):
                        # ნებართვის მიღების შემდეგ კამერის უსაფრთხო ჩართვა
    ...
    def build(self):
        ...
        root.add_widget(Label(
            text="LingoLens AI - Camera & Dialogue",
            font_size='18sp',
            bold=True,
            size_hint_y=0.05,
            color=(0.2, 0.8, 0.5, 1)
        ...
        # კამერა - ჩაირთვება უსაფრთხოდ (play=False) ნებართვის მიღებამდე
        self.camera = Camera(play=False, resolution=(640, 480), size_hint_y=0.34)
        root.add_widget(self.camera)

        # Input & Output
        self.input_text = TextInput(
            hint_text="ჩაწერეთ SMS/ტექსტი ან გამოიყენეთ Live OCR...",
            multiline=True, size_hint_y=0.17, font_size='14sp'
        )
        ...
        self.output_text = TextInput(
            ...
            multiline=True, readonly=True, size_hint_y=0.17, font_size='14sp'
        )
        ...
        # Status
        self.status = Label(text="მზადაა სამუშაოდ", size_hint_y=0.04, font_size='11sp')
    ...
    def capture_frame(self, dt):
        ...
        # პიქსელების ამოღება მთავარ თრედში, რომ არ ჩამოინგრეს აპლიკაცია
        try:
