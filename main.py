# ==============================================================================
# LingoLens AI - With Crash Logger (Window Manager Disabled for Testing)
...
# დაკომენტარებულია window_manager, რათა შევამოწმოთ იწვევს თუ არა ის ქრაშს
...
class LingoLensApp(App):
    ...
    def open_translator(self, instance=None, initial_text="", initial_result="", status_text=""):
        ...
        # MovableWindow ჩანაცვლებულია პირდაპირი Layout-ით
        box.size_hint = (0.9, 0.9)
    ...
    def open_dialogue(self, instance):
        try:
            ...
            dialogue_content.size_hint = (0.9, 0.9)
            dialogue_content.pos_hint = {'center_x': 0.5, 'center_y': 0.5}
            self.root_layout.add_widget(dialogue_content)
        except Exception as e:
