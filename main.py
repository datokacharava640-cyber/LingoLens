...
class MainScreen(Screen):
    ...
    # --- LingoLens ხმოვანი ასისტენტი ---
    def activate_voice_assistant(self):
        layout = BoxLayout(orientation='vertical', padding=15, spacing=10)
        
        lbl_status = Label(
            text="🎙️ LingoLens AI ასისტენტი\n\nთქვით ფრაზა ან დავალება:\nმაგ: \"გადამითარგმნე ეს ფრანგულად: გამარჯობა, როგორ ხარ?\"",
            font_name=FONT_PATH,
            halign='center',
            font_size='15sp',
            color=(0.2, 0.8, 1, 1)
    ...
    def process_assistant_command(self, user_command, lbl_status):
        ...
        # გაგზავნა სერვერზე ასისტენტის დასამუშავებლად
        url = f"{VERCEL_BASE_URL}/api/index"
        payload = {
