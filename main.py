# ==============================================================================
# LingoLens Ultra Pro Live AI 🇬🇪 - Official Production Code
# ==============================================================================
...
# 🛠️ შესწორებული ISO Locale კოდები Android TTS-ისთვის
LANGUAGES = {
...
class MainScreen(Screen):
    ...
    def open_ar_camera_mode(self):
        ...
        popup = Popup(title="AR Live Overlay", content=fl, size_hint=(0.95, 0.95))
    ...
    def _delayed_translate(self, text):
        ...
        UrlRequest(
            ...
            on_error=lambda req, err: self._on_server_error(),
            timeout=5
        )
    ...
    def _on_server_error(self):
        self.ids.output_text.text = "კავშირის შეცდომა."
