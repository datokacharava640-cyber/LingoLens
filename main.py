...
class LocalSLMEngine:
    def translate(self, text):
        # ლოკალური SLM დამუშავების ლოგიკა
        dictionary = {
...
class MainLayout(BoxLayout):
    def __init__(self, **kwargs):
        ...
        self.api_key = "AQ.Ab8RN6JRsQmchpFvza1mUDtsUWVQNye3OmrJWcCOrmV5UuWqWQ"
    ...
    # Translation Processing with Database Auto-Save
    def process_translation(self):
        ...
        try:
            ...
            # Automatic Switch to Local SLM Fallback
    ...
    # Android System Overlay Service Handler
