...
class LingoLensApp(App):
    ...
    def init_android_audio(self):
        try:
            ...
            # 2. დინამიკი Gemini ხმისთვის (24kHz PCM output)
    ...
    def connect_to_proxy(self):
        def on_open(ws):
            self.update_label("LingoLens: AI თარჯიმანი მზადაა")
            
            # ინსტრუქცია Gemini Live-ისთვის: ორმხრივი თარგმანი
            setup_msg = {
                "setup": {
                    ...
                    "systemInstruction": {
                        "parts": [
                            {
                                "text": "You are LingoLens Live AI Interpreter. Act as a real-time simultaneous interpreter between Georgian and English (or other languages spoken). Translate speech instantly and naturally without commentary."
                            }
                        ]
                    }
                }
