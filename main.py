# ==============================================================================
# LingoLens Ultra Pro Live AI 🇬🇪
# Creator / Author: David Kacharava (დავით კაჭარავა)
# Country: Georgia 🇬🇪
# Date: აგვისტო 22, 2026
# AI & License: Powered by Google Gemini AI Official Engine & Open Licenses
# ==============================================================================
...
# ---------------------------------------------------------
# Android Dynamic Permissions & Native Integration
# ---------------------------------------------------------
TTS = None
Recognizer = None
...
# Unicode / ქართული ფონტი
FONT_PATH = "DejaVuSans.ttf" if os.path.exists("DejaVuSans.ttf") else ("NotoSansGeorgian-Regular.ttf" if os.path.exists("NotoSansGeorgian-Regular.ttf") else "Roboto")

# 100+ ენების მხარდაჭერა
LANGUAGES = {
    ...
    BoxLayout:
        ...
        BoxLayout:
            ...
            Button:
                ...
                color: 1, 1, 1, 1
                on_release: root.show_about_info()
...
class MainScreen(Screen):
    ...
    def show_about_info(self):
        info_text = (
            "LingoLens Ultra Pro Live AI 🇬🇪\n\n"
            "• ავტორი / შექმნელი: დავით კაჭარავა\n"
            "• ქვეყანა: საქართველო 🇬🇪\n"
            "• თარიღი: აგვისტო 22, 2026\n"
            "• AI ძრავა & ლიცენზია: Google Gemini AI & Open Licenses\n"
            "• ფუნქციები: Real-time Live დიალოგი, ML Kit OCR, TTS/STT"
        )
        box = BoxLayout(orientation='vertical', padding=10, spacing=10)
        box.add_widget(Label(text=info_text, font_name=FONT_PATH, font_size='14sp', halign='center'))
        btn = Button(text="დახურვა", font_name=FONT_PATH, size_hint_y=None, height='40dp')
        popup = Popup(title='პროექტის შესახებ 🇬🇪', title_font=FONT_PATH, content=box, size_hint=(0.85, 0.5))
    ...
    def _delayed_translate(self, text):
        ...
        UrlRequest(
            ...
            on_failure=lambda req, res: self._on_translation_error(),
            timeout=5
        )
