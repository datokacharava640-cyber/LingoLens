...
# ---------------------------------------------------------
# 2. COMPLETE SERVICE MANAGER (Text, OCR, AR, PDF)
# ---------------------------------------------------------
...
# ---------------------------------------------------------
# 3. POPUP WIDGETS (Live Camera & AR Overlay)
# ---------------------------------------------------------
...
class LingoLensUI(BoxLayout):
    def __init__(self, **kwargs):
        ...
        # Actions Grid (Translate, OCR, AR, Live, PDF, Voice)
    ...
    def on_ar_select(self, instance):
        if filechooser:
            try:
                ...
                self.output_label.text = f"AR ფაილის არჩევის შეცდომა: {e}"
