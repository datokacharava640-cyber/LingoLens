...
# ვეძებთ შრიფტის ფაილს სხვადასხვა შესაძლო სახელით
possible_fonts = ["NotoSansGeorgian.ttf", "georgian.ttf", "font.ttf"]
font_path = None
...
class MainLayout(BoxLayout):
    ...
    def open_api_popup(self, instance):
        ...
        api_input = TextInput(hint_text="Gemini API Key...", text=self.api_key, multiline=False)
