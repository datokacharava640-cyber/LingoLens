...
# --- 📷 რეალური Android კამერის ვიჯეტი ---
class CameraARWidget(BoxLayout):
    def __init__(self, main_screen, **kwargs):
        ...
        # Android-ზე კამერის ინდექსის ავტომატური არჩევა
        cam_idx = 0
        if platform == 'android':
            cam_idx = 0  # ძირითადი უკანა კამერა
...
class MainScreen(Screen):
    ...
    # Android Native Voice Recognizer Listener
    ...
    # Android Native Speech Recognition Trigger
