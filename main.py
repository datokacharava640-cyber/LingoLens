...
# სისტემური უნიკოდ/ქართული შრიფტის მოძებნა Android/Desktop-ზე
FONT_NAME = "Roboto"
...
class LingoLensPro(MDApp):
    ...
    def build(self):
        # KivyMD-ის ყველა სტილის გადაწერა Unicode შრიფტით
    ...
    # ---------------------------------------------------------
    # FIXED CAMERA / OCR FUNCTION (NO MORE URI ERROR)
    # ---------------------------------------------------------
        ...
        if platform == 'android':
            try:
                ...
                try:
                    ...
                    # Cast Uri to Parcelable for Intent.putExtra
    ...
    # ---------------------------------------------------------
    # GEORGIAN TTS (AZURE / GOOGLE TTS FALLBACK)
    # ---------------------------------------------------------
