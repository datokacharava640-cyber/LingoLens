...
# --- 2. ვირუსული, ჭკვიანი & ხმოვანი მოდულები ---
...
class LingoLensApp(App):
    ...
    # --- Android Permissions Request On App Launch ---
    def on_start(self):
        if platform == 'android':
            try:
    ...
    def check_wake_word(self, dt):
        ...
        if is_triggered:
            ...
            self.live_interpreter.speak_text("LingoLens activated, how can I help you?")

    # --- Feature Handlers ---
    def feat_live_handsfree(self, instance):
        res = self.live_interpreter.toggle_handsfree_live()
        self.output_label.text = res
        self.live_interpreter.speak_text("Live conversation mode active.")
    ...
    def feat_voice_clone(self, instance):
        ...
        self.output_label.text = res
        self.live_interpreter.speak_text(txt)
    ...
    def feat_travel_sos(self, instance):
        ...
        self.output_label.text = res
        self.live_interpreter.speak_text("Emergency translation ready.")
