...
class MainScreen(Screen):
    ...
    def _wakeword_worker(self):
        ...
        try:
            porcupine = pvporcupine.create(
                ...
                keywords=["porcupine", "bumblebee"]  # ნაგულისხმევი Wake Words
            )
            ...
            while self.is_listening_wakeword:
                ...
                if result >= 0:
                    # დაძახება დაფიქსირდა ("Wake Word Detected!")
    ...
    def on_wakeword_detected(self):
        # გამოძახებისას ავტომატურად იხსნება AI ასისტენტი და იწყებს მოსმენას
