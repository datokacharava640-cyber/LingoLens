...
class LingoLensApp(App):
    ...
    def build(self):
        ...
        self.src_spin.option_cls.font_name = FONT_NAME
        ...
        self.tgt_spin.option_cls.font_name = FONT_NAME
        ...
        try:
            ...
            self.camera = Label(text="Camera Unavailable", size_hint_y=0.28, font_name=FONT_NAME)
