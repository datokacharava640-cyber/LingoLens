...
# Keep Screen Awake for Real-Time Live Streaming
...
class LingoLensRealTimeUI(BoxLayout):
    def __init__(self, **kwargs):
        ...
        header_box.add_widget(CustomLabel(text='LingoLens Live Stream AI', font_size='18sp', bold=True))
    ...
    def start_speech_recognizer(self, lang_code):
        ...
        try:
            ...
            # Enable Offline Recognition Fallback
