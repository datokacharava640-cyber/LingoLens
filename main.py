...
class MainScreen(Screen):
    ...
    def speak_output_text(self, custom_text=None):
        ...
        threading.Thread(target=self._play_audio_stream, args=(text, lang_code), daemon=True).start()

    def _play_audio_stream(self, text, lang_code):
        ...
        try:
            ...
            print(f"Desktop Audio Playback Error: {e}")
