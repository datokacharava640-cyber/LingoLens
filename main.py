...
class LingoLensApp(App):
    ...
    def build(self):
        ...
        self.ocr_in_progress = False  # ხელს უშლის მოთხოვნების გადაფარვას
    ...
    def toggle_live(self, instance):
        if not self.is_live:
            ...
            self.live_event = Clock.schedule_interval(self.capture_frame, 2.0)
