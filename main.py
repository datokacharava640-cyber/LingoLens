...
class LingoLensUI(BoxLayout):
    def __init__(self, user_data_dir=".", **kwargs):
        ...
        # 2. Input Text Box (ტექსტის შესაყვანი)
        ...
        btn_speak = Button(text="🔊 ხმა", size_hint_x=0.25, font_name=DEFAULT_FONT, font_size='13sp')
        ...
        # 4. Languages Bar (დაპატარავებული და ქვემოთ ჩამოტანილი)
        ...
        # 5. Live Dialog Voice Buttons (ხმოვანი ღილაკები)
