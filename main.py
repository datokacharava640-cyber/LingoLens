...
# =====================================================================
# 1. შრიფტის უსაფრთხო რეგისტრაცია
# =====================================================================
GEORGIAN_FONT = None
...
# Kivy-ს სტილების უსაფრთხო ჩატვირთვა
if GEORGIAN_FONT:
...
# =====================================================================
# 2. აპლიკაციის ძირითადი ინტერფეისი
# =====================================================================
class MainLayout(BoxLayout):
    def __init__(self, **kwargs):
        ...
        self.status_label = Label(
            text="Engine Ready! | Daily Streak: 1 Days",
            color=(0.2, 0.8, 0.2, 1),
            font_size='13sp',
            size_hint_y=0.05
        )
    ...
    def open_api_popup(self, instance):
        ...
        save_btn = Button(text="Save Key", size_hint_y=0.4)
...
class LingoLensApp(App):
    ...
    def on_start(self):
        # Android-ის უფლებების მოთხოვნა უსაფრთხოდ, აპლიკაციის ჩატვირთვის შემდეგ
        if platform == 'android':
