# ==============================================================================
# LingoLens Ultra Pro v3.3.0 🇬🇪 - Universal Android Native Engine
# ==============================================================================
...
# Certifi SSL Fix for Mobile HTTPS Requests
try:
    import certifi
...
ADVANCED_OFFLINE_DB = {
    ("ka", "en_US"): {
        ...
        "სად არის სასტუმრო": "Where is the hotel"
    },
    ("en_US", "ka"): {
...
# --- 📷 რეალური Android კამერის ვიჯეტი (უსაფრთხო ჩართვით) ---
class CameraARWidget(BoxLayout):
    ...
    def start_camera(self):
        ...
        self.clock_event = Clock.schedule_interval(self.update_frame, 1.0 / 25.0)
    ...
    def update_frame(self, dt):
        ...
        if not self.is_processing and (current_time - self.last_api_call > 1.2):
        ...
        if self.ar_text_overlay:
            ...
            cv2.putText(frame, self.ar_text_overlay, (20, 50), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 187), 2)
...
class MainScreen(Screen):
    ...
    def open_conversation_mode(self):
        ...
        self.conv_label = Label(
            ...
            size_hint_y=None, markup=True, color=(1, 1, 1, 1), font_size='14sp'
        )
        ...
        self.btn_auto = Button(text="▶️ Start Live Loop", background_color=(0.1, 0.7, 0.3, 1), color=(1, 1, 1, 1))
        self.btn_auto.bind(on_release=self.toggle_auto_dialog_loop)
        btns_layout.add_widget(self.btn_auto)
        box.add_widget(btns_layout)

        close_btn = Button(text="❌ დასრულება", size_hint_y=None, height='40dp', background_color=(0.3, 0.3, 0.3, 1))
    ...
    def open_ar_camera_mode(self):
        ...
        close_btn = Button(text="❌ დახურვა", size_hint_y=None, height='45dp', background_color=(0.8, 0.2, 0.2, 1))
        box.add_widget(close_btn)
        ...
        # კამერის უსაფრთხო ჩართვა 팝업-ის გამოჩენის შემდეგ
        self.ar_cam.start_camera()
    ...
    def open_language_menu(self, mode):
        ...
        for lang_name, code in LANGUAGES.items():
            btn = Button(text=lang_name, size_hint_y=None, height='42dp', background_color=(0.14, 0.17, 0.24, 1), color=(1, 1, 1, 1))
...
# --- 🚀 Android Permisssions & Main App Class ---
